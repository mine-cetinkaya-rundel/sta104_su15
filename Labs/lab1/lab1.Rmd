...
download("https://stat.duke.edu/courses/Summer15/sta104.01-1/post/labs/sta104_lab1.Rmd", destfile = "sta104_lab1.Rmd")
```
</div>
...
Answer the following questions using the survey data. You must also manipulate at least one of the variables.
