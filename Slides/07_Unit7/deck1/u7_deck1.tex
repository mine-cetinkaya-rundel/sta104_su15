...
\subtitle{1. Introduction to MLR + Model selection}
...
\item Bunch of final review materials posted

\item PA 6 due tonight

\item Project due Saturday night

\item Lab 7 + Peer eval 3 due Sunday night
